package com.payam.learn.persistence.servlets;

import com.payam.learn.persistence.model.Employee;
...
public class EmployeeServlet {
    ...
    public final Logger logger = Logger.getLogger(String.valueOf(EmployeeServlet.class));
